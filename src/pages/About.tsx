      ...
      <main className="flex-1">
        ...
        >
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-5xl md:text-6xl font-heading font-bold mb-4">About Car Street</h1>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
                <p>
                  Founded in 2008, Car Street has been serving the Mississauga community for over 15 years. What started as a small family-owned dealership has grown into one of the region's most trusted names in quality pre-owned vehicles.
                </p>
                <p>
